...
export const PinContainer = ({
  ...
  return (
    ...
    >
      ...
      <div className="block lg:hidden relative p-4 sm:p-6 rounded-2xl border border-white/[0.1] hover:border-purple/30 active:scale-[0.97] active:brightness-110 transition-all duration-200 overflow-hidden w-full bg-[#04071D] shadow-xl">
        <div className={cn("relative z-50", className)}>{children}</div>
      </div>
