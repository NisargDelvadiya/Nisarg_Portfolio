 ...
 * Displays branding, quick navigation links, and dynamic clock with responsive design.
 */
const Navbar = () => {
    ...
    >
      ...
      <nav aria-label="Desktop menu" className="flex items-center gap-4 sm:gap-8 md:gap-10 overflow-x-auto no-scrollbar bg-transparent">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center gap-2 sm:gap-3 cursor-pointer hover:opacity-90 transition-opacity focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none rounded-md px-1"
        ...
        >
          ...
          <span className="font-bold tracking-tight text-white text-xs sm:text-[15px] whitespace-nowrap">
            Nisarg's Portfolio
          </span>
        </a>
      ...
      <div className="flex items-center flex-shrink-0 pl-2">
        <time
          ...
          className="font-medium text-white/95 text-xs sm:text-sm tracking-wide whitespace-nowrap"
