...
const ALL_LANGUAGES = [
  {
    ...
    isKnown: true,
    badge: "Daily Driver",
    humor: "Fluent in English, TypeScript & StackOverflow 💻",
  },
  ...
  { code: "doi", name: "Dogri", nativeName: "डोगरी" },
  {
    ...
    isKnown: true,
    badge: "Mother Tongue",
    humor: "Kem Cho! 100% Native — born, bred & runs on Chai 🫓",
  },
  {
    code: "hi",
    name: "Hindi",
    ...
    isKnown: true,
    badge: "Dil Se Desi",
    humor: "Bollywood quotes, deep convos & daily banter fluent 🎬",
  },
  ...
  { code: "pa", name: "Punjabi", nativeName: "ਪੰਜਾਬੀ" },
  {
    ...
    humor: "Aham Brahmasmi — can chant shlokas while debugging code 🕉️",
  },
