  ...
  return (
    <div
      className={`flex flex-col bg-white dark:bg-[#1e1e22] text-gray-800 dark:text-white rounded-xl shadow-2xl overflow-hidden border border-black/10 dark:border-white/10 select-none transition-colors duration-200 ${
        isMaximized ? 'w-full h-[calc(100vh-140px)]' : 'w-[480px] max-w-[94vw]'
      }`}
    >
      {/* Window Header */}
      ...
      {/* Body Content */}
      <main className="p-4 sm:p-6 md:p-8 space-y-4 sm:space-y-5 flex-1 overflow-y-auto overscroll-contain bg-white dark:bg-[#18181c]">
        <div>
        ...
        <div className="bg-gray-50 dark:bg-[#222228] border border-gray-200 dark:border-white/10 rounded-xl p-3 sm:p-4 flex items-center justify-between gap-2.5 shadow-sm">
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-semibold flex items-center justify-center gap-1.5 transition-all cursor-pointer shadow-sm flex-shrink-0 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none ${
              copied
            ...
            {socials.map((social) => (
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 sm:gap-3 cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none rounded"
