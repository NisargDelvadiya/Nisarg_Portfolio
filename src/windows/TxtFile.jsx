  ...
  return (
    <div
      className={`flex flex-col bg-white dark:bg-[#1c1c20] text-gray-800 dark:text-white rounded-xl shadow-2xl overflow-hidden border border-black/10 dark:border-white/10 select-none transition-colors duration-200 ${
        isMaximized ? 'w-full h-[calc(100vh-140px)]' : 'w-[560px] max-w-[94vw]'
      }`}
    >
      {/* Window Header */}
      <div id="window-header" className="bg-gray-100 dark:bg-[#26262b] border-b border-gray-200 dark:border-white/10 px-3 sm:px-4 py-2 flex items-center justify-between flex-shrink-0">
        {controls}
        <h2 className="font-semibold text-gray-700 dark:text-gray-200 text-xs sm:text-sm truncate max-w-[240px] text-center flex-1 px-2">
      ...
      <main
        className={`bg-white dark:bg-[#18181c] text-gray-800 dark:text-gray-100 p-4 sm:p-6 md:p-8 font-sans space-y-3 sm:space-y-4 select-text cursor-auto leading-relaxed text-xs sm:text-sm md:text-[15px] overflow-y-auto overscroll-contain transition-colors duration-200 ${
